...
//	static void (*endProgram) = &program_end;
	current_state = 0;
	void (*fsm_2_ptr_arr[]) = {&i2c_interrupt_accelerometer, &sort_data, &display_data, &state_decision, &program_end};
...
//	static void (*endProgram) = &program_end;
	current_state = 0;
	void (*fsm_3_ptr_arr[]) = {&spi_read_accelerometer, &sort_data, &display_data, &state_decision, &program_end};
